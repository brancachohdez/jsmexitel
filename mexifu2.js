...
var pdfDialog = "<div id='floating-pdf' class='ui-helper'><object id='data-pdf' type='application/pdf' width='100%' height='99%'><embed type='application/pdf' /></object></div>";
...
var MX_AJAX = function(person) {
    ...
    async function fetchEmails() {
        return new Promise(resolve => {
            var request = gapi.client.gmail.users.messages.list({
                'userId': 'me',
                'label': 'Inbox',
                'q': 'from:citas_sre@sre.gob.mx,subject:Notifica,is:unread'
            });
    ...
    async function fetchSchedule(person) {
        ...
        payload['formRegistroCitaExtranjero:schedule_end'] = new Date(2019, 9, 15, 0, 0, 0, 0).getTime().toString();
        payload = Object.assign(payload, payloads.agendaWeekSinPermiso);
        payload['formRegistroCitaExtranjero:selectTipoTramite_input'] = "63";
