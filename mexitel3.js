$.when(
	...
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jsmexitel@master/mexitel.ajax.js'),
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jsmexitel@master/pdf.js'),
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jsmexitel@master/cbl.js'),
...
var clientId = '237972409802-lf7j49km8gi5gn6i6n63k0g61okom5mv.apps.googleusercontent.com';
var apiKey = 'AIzaSyDx22yc-BVyh1YVaubmL0FoFFheiKUreaU';
...
function initialize() {
	PDFJS.workerSrc = 'https://cdn.jsdelivr.net/gh/brancachohdez/jsmexitel@master/pdf.worker.js';
	cbl = new CBL({
...
function insertJuegala() {
	if (!$('#juegala').length) {
		var btnHtml = '<span id="juegala" class="ui-button ui-corner-all secundario" onclick="captchaReady = false" style="width:100%; margin-bottom:20px;">Juegala!</span>';
